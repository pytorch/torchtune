...
We support any custom dataset that you provide through:

- Hugging Face Hub
- Remote files via HTTP URLs
- Local CSV, JSON, Parquet, Arrow files
- Local Hugging Face loading scripts

We also support built-in, well-tested, flagship datasets that are commonly used to fine-tune LLMs.

| Type                                              | Name                                           |   Description |
|---------------------------------------------------|------------------------------------------------|-----------------------------------------------------------|
| [InstructDataset](torchtune/datasets/_instruct.py)| [Alpaca](torchtune/datasets/_alpaca.py)        | Instruction-following data generated by OpenAI's `text-davinci-003` engine ([hub](https://huggingface.co/datasets/tatsu-lab/alpaca), [repo](https://github.com/tatsu-lab/stanford_alpaca))|
| [InstructDataset](torchtune/datasets/_instruct.py)| [Alpaca-Cleaned](torchtune/datasets/_alpaca.py)| Cleaned version of Alpaca that removes hallucinations, malformed samples, and more ([hub](https://huggingface.co/datasets/yahma/alpaca-cleaned), [repo](https://github.com/gururise/AlpacaDataCleaned))|
| [InstructDataset](torchtune/datasets/_instruct.py)| [SAMsum](torchtune/datasets/_samsum.py)        | Messenger-like conversations with summaries ([hub](https://huggingface.co/datasets/samsum))|
| [ChatDataset](torchtune/datasets/_chat.py)        | [SlimOrca](torchtune/datasets/_slimorca.py)    | Curated subset of OpenOrca consisting of GPT completions ([hub](https://huggingface.co/datasets/Open-Orca/SlimOrca))|
