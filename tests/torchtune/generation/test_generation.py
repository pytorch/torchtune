...
class TestGenerate:
    ...
    def test_stop_tokens_batched_uneven_stopping(
        ...
        expected_output = torch.tensor(
            [
                [2, 3, 4, 5, 6, 7, 8, 9, 3987, 3959, 3999],
                [2, 3, 4, 5, 6, 7, 8, 9, 3993, 3967, 0],
                [2, 3, 4, 5, 6, 7, 8, 9, 3957, 0, 0],
            ]
        )
    ...
    def test_stop_tokens_batched_uneven_stopping_left_padded(
        ...
        expected_output = torch.tensor(
            [
                [0, 0, 2, 3, 4, 5, 6, 7, 8, 9, 3987, 3959, 3999],
                [0, 0, 2, 3, 4, 5, 6, 7, 8, 9, 3993, 3967, 0],
                [0, 0, 2, 3, 4, 5, 6, 7, 8, 9, 3957, 0, 0],
            ]
        )
        assert torch.equal(outputs, expected_output)
