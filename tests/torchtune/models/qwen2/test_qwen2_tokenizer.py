...
class TestQwenTokenizer:
    ...
    def test_tokenize_messages(self, messages):
        ...
        expected_tokens = [2001, 273, 105, 94, 33, 214, 174, 156, 194, 130, 197, 184, 446, 789, 113, 98, 1914, 13, 346,
                           788, 98, 706, 102,
                           182, 184, 1916, 176, 762, 83, 113, 103, 874, 269, 13, 94, 94, 2, 2, 2, 483, 197, 25, 94, 885,
                           98, 1226, 1960,
                           348, 114, 1123, 399, 1583, 78, 13, 94, 94, 2, 2, 2, 360, 1733, 102, 182, 25, 94, 2002, 94,
                           2001, 397, 251, 249,
                           94, 40, 1791, 194, 453, 70, 78, 114, 120, 967, 176, 618, 628, 1275, 794, 294, 1095, 445, 212,
                           1356, 120, 1299,
                           13, 223, 1791, 451, 98, 127, 181, 1047, 375, 915, 380, 120, 1448, 1732, 114, 453, 447, 1219,
                           64, 187, 921, 120,
                           742, 107, 84, 122, 893, 13, 223, 1791, 98, 127, 181, 123, 124, 131, 103, 744, 82, 120, 1506,
                           416, 114, 128,
                           1429, 182, 253, 82, 120, 163, 330, 105, 262, 13, 223, 1791, 155, 1551, 171, 1951, 628, 296,
                           64, 237, 886, 1390,
                           130, 883, 1678, 447, 306, 279, 113, 11, 215, 785, 215, 1951, 628, 378, 101, 66, 72, 593, 98,
                           984, 208, 1580,
                           167, 510, 737, 318, 1278, 13, 2000]  # noqa
        # fmt: on
    ...
    def test_tokenize_message_drop_eos(self, messages):
        ...
        expected_tokens = [2001, 273, 105, 94, 33, 214, 174, 156, 194, 130, 197, 184, 446, 789, 113, 98, 1914, 13, 346,
                           ...
                           215, 1951, 628, 378, 101, 66, 72, 593, 98, 984, 208, 1580, 167, 510, 737, 318, 1278, 13] # noqa
        # fmt: on
