...
class TestRAFTDataset:
    ...
    def test_label_masking(self, load_deep_lake_dataset, tokenizer):
        ...
        load_deep_lake_dataset.return_value = [
            {
                "instruction": """<DOCUMENT> Artificial Intelligence (AI) is revolutionizing industries worldwide,
                            from healthcare to finance. By analyzing vast amounts of data, AI algorithms can detect
                            patterns and make predictions with unprecedented accuracy.</DOCUMENT>
                            <DOCUMENT>In the realm of autonomous vehicles, AI plays a pivotal role in enabling
                            safe and efficient navigation. Through real-time data processing and machine learning,
                            self-driving cars can adapt to diverse road conditions and make split-second
                            decisions.</DOCUMENT>
                            <DOCUMENT>AI-powered virtual assistants, like Siri and Alexa, have become ubiquitous
                            in our daily lives. These intelligent systems utilize natural language processing and
                            machine learning algorithms to understand and respond to user queries, simplifying tasks
                            and enhancing user experience.</DOCUMENT>
                            What are some key applications of artificial intelligence across different industries?""",
                "cot_answer": """##Reason: To answer the question about the applications of artificial intelligence
                            across different industries, we need to consider the provided context.
                            Here is the step-by-step reasoning:
                            ...
                            Autonomous vehicles: AI enables safe navigation and decision-making in self-driving cars.
                            Virtual assistants: AI powers intelligent systems like Siri and Alexa for natural language
                            processing and task automation. Summarize the main industries benefiting from AI:
                            Healthcare, transportation, and consumer electronics.
                            ##Answer: Some key applications of artificial intelligence across different industries
                            include healthcare analytics, autonomous vehicles for transportation,
