...
class TestRAFTDataset:
    ...
    def test_label_no_masking(self, load_deep_lake_dataset, tokenizer):
        ...
        load_deep_lake_dataset.return_value = [
            {
                "instruction": """<DOCUMENT> Artificial Intelligence (AI) is revolutionizing industries worldwide, from healthcare to finance. 
                By analyzing vast amounts of data, AI algorithms can detect patterns and make predictions with unprecedented accuracy.</DOCUMENT>
                <DOCUMENT>In the realm of autonomous vehicles, AI plays a pivotal role in enabling safe and efficient navigation. 
                Through real-time data processing and machine learning, self-driving cars can adapt to diverse road conditions and make split-second decisions.</DOCUMENT>
                <DOCUMENT>AI-powered virtual assistants, like Siri and Alexa, have become ubiquitous in our daily lives. 
                These intelligent systems utilize natural language processing and machine learning algorithms to understand and respond to user queries, 
                simplifying tasks and enhancing user experience.</DOCUMENT>
                What are some key applications of artificial intelligence across different industries?""",
                "cot_answer": """##Reason: To answer the question about the applications of artificial intelligence across different industries, we need to consider the provided context. 
                ...
                Virtual assistants: AI powers intelligent systems like Siri and Alexa for natural language processing and task automation.
                Summarize the main industries benefiting from AI: Healthcare, transportation, and consumer electronics.
                ##Answer: Some key applications of artificial intelligence across different industries include healthcare analytics, autonomous vehicles for transportation, 
                and virtual assistants in consumer electronics."""
    ...
    @patch("torchtune.datasets._instruct_raft.load_deep_lake_dataset")
    def test_label_masking(self, load_deep_lake_dataset, tokenizer):
        """
        ...
        raft_ds = raft_dataset(tokenizer=tokenizer, train_on_input=False)

        # Extract the prompt and tokenize it; we'll need this to test whether we're masking the
        # input correctly
        sample = raft_ds._data[0]
        prompt = raft_ds.template.format(sample=sample)
