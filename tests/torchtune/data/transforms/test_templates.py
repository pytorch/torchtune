...
from torchtune.data.transforms import (
    ChatMLTemplate,
...
class TestLlama2ChatTemplate:
    ...
    def test_format(self):
        actual = Llama2ChatTemplate()(CHAT_SAMPLE["messages"])
...
class TestMistralChatTemplate:
    ...
    def test_format(self):
        no_system_sample = CHAT_SAMPLE["messages"][1:]
    ...
    def test_format_with_system_prompt_raises(self):
        with pytest.raises(
            ...
            _ = MistralChatTemplate()(CHAT_SAMPLE["messages"])
...
class TestChatMLTemplate:
    ...
    def test_format(self):
        actual = ChatMLTemplate()(CHAT_SAMPLE["messages"])
        assert_dialogue_equal(actual, self.expected_dialogue)
...
class TestSummarizeTemplate:
    samples = [
        ...
        [
            Message(
                role="user",
                content="Olivia: Who are you voting for in this election? Oliver: Liberals as always. "
                "Olivia: Me too!! Oliver: Great",
            ),
            Message(
                role="assistant",
