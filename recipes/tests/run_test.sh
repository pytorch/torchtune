...
S3_URLS=("s3://pytorch-multimodal/llama2-7b/tokenizer.model" "s3://pytorch-multimodal/small-ckpt-01222024")
PYTEST_COMMAND="pytest recipes/tests"

if [[ $# -gt 0 ]]; then
    if [ "$1" = "--large-scale" ]; then
        S3_URLS+=("s3://pytorch-multimodal/llama2-7b/llama2-7b-01222024")
