...
class LoraGRPOFinetuneRecipe(FTRecipeInterface):
    ...
    def save_checkpoint(
        ...
        - Adapter weights with key training.ADAPTER_KEY
        ...
        # Get adapter state dict for checkpointing
        ...
        if self._is_rank_zero:
            ...
            checkpoint_dict.update({
                training.MODEL_KEY: cpu_state_dict,
                training.ADAPTER_KEY: adapter_state_dict,
            })

            # Add adapter config for easier loading
            adapter_config = {
                "r": self._lora_rank,
