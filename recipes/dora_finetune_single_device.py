...
class LoRAFinetuneRecipeSingleDevice(FTRecipeInterface):
    ...
    def _setup_model(
        ...
        # initialize dora (this will run init_dora in the lora_linear layer. if not self.lora_m will be 0. i.e just lora.)
        activate_dora_parms(model)
...
def recipe_main(cfg: DictConfig) -> None:
    ...
    """
    config.log_config(recipe_name="DoRAFinetuneRecipeSingleDevice", cfg=cfg)
