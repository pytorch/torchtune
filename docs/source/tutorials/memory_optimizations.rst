...
.. csv-table:: Memory optimization components
   ...
   ":ref:`glossary_low_precision_opt`", "Use when you want to reduce the size of the optimizer state. This is relevant when training large models and using optimizers like Adam, that require 2x # model parameters. Note that lower precision optimizers may reduce training stability/accuracy."
