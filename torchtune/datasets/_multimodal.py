...
def multimodal_dataset(
    ...
    **load_dataset_kwargs: Dict[str, Any],
    ...
    """
    Build a configurable dataset with image and text data. This method should be
    used to configure a custom multimodal dataset from the yaml config instead of
    using :class:`~torchtune.datasets.MultimodalDataset` directly, as it is made to be config friendly.
    ...
    Examples:
        >>> from torchtune.datasets import multimodal_dataset
    ...
    This can also be accomplished via the yaml config::
        ...
        dataset:
            _component_: torchtune.datasets.multimodal_dataset
            source: HuggingFaceH4/no_robots
            conversation_style: sharegpt
            chat_format: torchtune.data.ChatMLFormat
            max_seq_len: 2096
