...
def qwen2_7b() -> TransformerDecoder:
    """
    Builder for creating a Qwen2.5 model initialized w/ the default 7B parameter values
...
def qwen2_1_5b() -> TransformerDecoder:
    """
    Builder for creating a Qwen2.5 model initialized w/ the default 1.5B parameter values
...
def lora_qwen2_7b(
    ...
    """
    Builder for creating a Qwen2.5 7B model with LoRA enabled.

    The Qwen2.5 defaults are the same as in :func:`~torchtune.models.qwen2_5.qwen2_7b`,
...
def lora_qwen2_0_5b(
    ...
    The Qwen2.5 defaults are the same as in :func:`~torchtune.models.qwen2_5.qwen2_0_5b`,
    while LoRA default params are based on
    https://github.com/tloen/alpaca-lora/blob/8bb8579e403dc78e37fe81ffbb253c413007323f/finetune.py#L41-L43.
...
def lora_qwen2_1_5b(
    ...
    """
    Builder for creating a Qwen2.5 1.5B model with LoRA enabled.

    The Qwen2.5 defaults are the same as in :func:`~torchtune.models.qwen2_5.qwen2_1_5b`,
    while LoRA default params are based on
    https://github.com/tloen/alpaca-lora/blob/8bb8579e403dc78e37fe81ffbb253c413007323f/finetune.py#L41-L43.
...
def lora_qwen2_3b(
    ...
    The Qwen2.5 defaults are the same as in :func:`~torchtune.models.qwen2_5.qwen2_3b`,
    while LoRA default params are based on
    https://github.com/tloen/alpaca-lora/blob/8bb8579e403dc78e37fe81ffbb253c413007323f/finetune.py#L41-L43.
...
def lora_qwen2_14b(
    ...
    The Qwen2.5 defaults are the same as in :func:`~torchtune.models.qwen2_5.qwen2_14b`,
    while LoRA default params are based on
    https://github.com/tloen/alpaca-lora/blob/8bb8579e403dc78e37fe81ffbb253c413007323f/finetune.py#L41-L43.
...
def lora_qwen2_32b(
    ...
    The Qwen2.5 defaults are the same as in :func:`~torchtune.models.qwen2_5.qwen2_32b`,
    while LoRA default params are based on
    https://github.com/tloen/alpaca-lora/blob/8bb8579e403dc78e37fe81ffbb253c413007323f/finetune.py#L41-L43.
...
def lora_qwen2_72b(
    ...
    The Qwen2.5 defaults are the same as in :func:`~torchtune.models.qwen2_5.qwen2_72b`,
    while LoRA default params are based on
    https://github.com/tloen/alpaca-lora/blob/8bb8579e403dc78e37fe81ffbb253c413007323f/finetune.py#L41-L43.
