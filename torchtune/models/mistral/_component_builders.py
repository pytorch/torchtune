...
def lora_mistral_lm(
    ...
    *,
    ...
    """
    Return a Mistral model (an instance of :func:`~torchtune.modules.TransformerLM`)
    with LoRA applied based on the passed in configuration.
    ...
    return TransformerLM(decoder=decoder, output=lm_output_proj)
...
def lora_mistral_lm_with_value_head(
    ...
    *,
    ...
    """
    Return a wrapped version of Mistral (an instance of :func:`~torchtune.modules.TransformerLMWithValueHead`)
    which also includes a value head, and with LoRA applied based on the passed in configuration.
