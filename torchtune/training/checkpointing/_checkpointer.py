...
class FullModelHFCheckpointer(_CheckpointerInterface):
    ...
    def load_checkpoint(self) -> Dict[str, Any]:
        ...
        for cpt_idx, cpt_path in enumerate(self._checkpoint_paths):
            ...
            del state_dict
            gc.collect()
        if self._model_type == ModelType.PHI3_MINI or self._model_type == ModelType.PHI4_MINI:
            log_rank_zero(
                logger=logger,
            ...
            if self._model_type == ModelType.PHI3_MINI:
                ...
                from torchtune.models.phi4._convert_weights import phi4_hf_to_tune

                converted_state_dict[training.MODEL_KEY] = phi4_hf_to_tune(
                    merged_state_dict,
                    num_heads=num_heads,
                    num_kv_heads=num_kv_heads,
                    dim=dim,
