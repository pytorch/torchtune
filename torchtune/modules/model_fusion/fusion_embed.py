...
class FusionEmbedding(nn.Module):
    def __init__(self, vocab_size: int, additional_tokens: int, embed_dim: int) -> None:
        ...
        The FusionEmbedding keeps the original embedding frozen while learning a much smaller
        second embedding for the additional tokens. During forward the module routes
